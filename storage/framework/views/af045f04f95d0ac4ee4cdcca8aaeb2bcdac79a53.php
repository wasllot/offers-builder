...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(auth()->guard('admin')->check() ? 'admin::layouts.master' : 'shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\Agencia - Proyectos en curso\bagisto-flaya\packages\Webkul\Admin\src\Providers/../Resources/views/errors/404.blade.php ENDPATH**/ ?>