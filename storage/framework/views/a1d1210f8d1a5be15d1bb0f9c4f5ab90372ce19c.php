<?php if($product->type == 'bundle'): ?>
    ...
    <bundle-option-list class="p-4"></bundle-option-list>
        ...
        <script type="text/x-template" id="bundle-option-list-template">
            <div class="bundle-options-wrapper">
                ...
                <div class="bundle-summary">
                    <h3 class="mb10"><?php echo e(__('shop::app.products.your-customization')); ?></h3>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH C:\Users\user\Desktop\Agencia - Proyectos en curso\bagisto-flaya/resources/themes/velocity/views/products/view/bundle-options.blade.php ENDPATH**/ ?>