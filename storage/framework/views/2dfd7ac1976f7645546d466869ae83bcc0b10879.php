<?php if(Webkul\Product\Helpers\ProductType::hasVariants($product->type)): ?>
    ...
    <?php $configurableOptionHelper = app('Webkul\Product\Helpers\ConfigurableOption'); ?>
    ...
    <?php echo view_render_event('bagisto.shop.products.view.configurable-options.before', ['product' => $product]); ?>
        ...
        <product-options class="p-4"></product-options>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script type="text/x-template" id="product-options-template">
            <div class="attributes p-4" v-if="childAttributes.length > 0">
                <input
                    type="hidden"
                ...
                <div
                    ...
                    <span class="swatch-container" v-else>
                        ...
                        <span v-if="! attribute.options.length" class="no-options"><?php echo e(__('shop::app.products.select-above-options')); ?></span>
                    </span>
        ...
        <script type="text/javascript">
            (() => {
                var galleryImages = <?php echo json_encode($galleryImages, 15, 512) ?>;
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH C:\Users\user\Desktop\Agencia - Proyectos en curso\bagisto-flaya/resources/themes/velocity/views/products/view/configurable-options.blade.php ENDPATH**/ ?>