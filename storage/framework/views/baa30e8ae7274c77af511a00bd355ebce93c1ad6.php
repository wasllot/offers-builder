...
<?php echo view_render_event('bagisto.shop.products.wishlist.before'); ?>
    ...
    <?php if(auth()->guard('customer')->guest()): ?>
        <wishlist-component
            ...
            remove-text="<?php echo e(__('shop::app.customer.account.wishlist.remove')); ?>"
            add-tooltip="<?php echo e(__('velocity::app.shop.wishlist.add-wishlist-text')); ?>"
            remove-tooltip="<?php echo e(__('velocity::app.shop.wishlist.remove-wishlist-text')); ?>">
        </wishlist-component>
    <?php endif; ?>
<?php echo view_render_event('bagisto.shop.products.wishlist.after'); ?><?php /**PATH C:\Users\user\Desktop\website-builder/resources/themes/velocity/views/products/wishlist.blade.php ENDPATH**/ ?>