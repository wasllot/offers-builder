...
<?php echo view_render_event('bagisto.shop.products.view.gallery.before', ['product' => $product]); ?>
    ...
    <div class="product-image-group">
        <div class="row col-12">
            <magnify-image src="<?php echo e($images[0]['large_image_url']); ?>" v-if="!isMobile()">
            </magnify-image>

            <img
                v-else
                class="vc-small-product-image"
                src="<?php echo e($images[0]['large_image_url']); ?>" />
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\user\Desktop\Agencia - Proyectos en curso\bagisto-flaya/resources/themes/velocity/views/products/view/gallery.blade.php ENDPATH**/ ?>