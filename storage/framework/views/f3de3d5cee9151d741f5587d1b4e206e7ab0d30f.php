        ...
        <div class="add-to-cart-btn pl0">
            ...
            <?php else: ?>
                <add-to-cart
                    ...
                    btn-text="<?php echo e(($product->type == 'booking') ?  __('shop::app.products.book-now') : $btnText ?? __('shop::app.products.add-to-cart')); ?>">
                </add-to-cart>
            <?php endif; ?>
        </div>
    </div>

<?php echo view_render_event('bagisto.shop.products.add_to_cart.after', ['product' => $product]); ?><?php /**PATH C:\Users\user\Desktop\website-builder/resources/themes/velocity/views/products/add-to-cart.blade.php ENDPATH**/ ?>