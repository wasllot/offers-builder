...
<html lang="{{ app()->getLocale() }}">
  ...
  <body>
    ...
    <div id="app">
						...
						<h1 class="mb-5">The Eassiest Way to Get Your New Job</h1>
								...
								<div class="col-md-12 tab-wrap">
									...
									<div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
										<form method="GET" role="search" id="search-form" :action="route" class="search-job">
											<div class="row no-gutters">
												<div class="col-md mr-md-2">
													<div class="form-group">
														<div class="form-field">
															<div class="icon"><span class="icon-briefcase"></span></div>
															<input type="text" name="category" class="form-control" placeholder="Ingrese el término a buscar">
														</div>
													</div>
												</div>
												<div class="col-md mr-md-2">
		...
		<section class="ftco-section bg-light">
			<div class="container">
				...
				<div class="sidebar-box ftco-animate">
					<div class="">
						<a href="#" class="company-wrap"><img src="{{ asset('themes/website/assets/images/company-1.jpg') }}" class="img-fluid" alt="Colorlib Free Template"></a>
						<div class="text p-3">
				...
				<div class="sidebar-box ftco-animate">
					<div class="">
						<a href="#" class="company-wrap"><img src="{{ asset('themes/website/assets/images/company-2.jpg') }}" class="img-fluid" alt="Colorlib Free Template"></a>
						<div class="text p-3">
				...
				<div class="sidebar-box ftco-animate">
					<div class="">
						<a href="#" class="company-wrap"><img src="{{ asset('themes/website/assets/images/company-3.jpg') }}" class="img-fluid" alt="Colorlib Free Template"></a>
						<div class="text p-3">
				...
				<div class="sidebar-box ftco-animate">
					<div class="">
						<a href="#" class="company-wrap"><img src="{{ asset('themes/website/assets/images/company-4.jpg') }}" class="img-fluid" alt="Colorlib Free Template"></a>
						<div class="text p-3">
							<h3><a href="#">IT Programming INC</a></h3>
							<p><span class="number">700</span> <span>Open position</span></p>
						</div>
			...
			<div class="col-md-12">
				...
				<div class="item">
					...
					<div class="text">
						...
						<div class="d-flex align-items-center">
							<div class="user-img" style="background-image: url(themes/website/assets/images/person_1.jpg)"></div>
							<div class="pl-3">
				...
				<div class="item">
					...
					<div class="text">
						<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						<div class="d-flex align-items-center">
							<div class="user-img" style="background-image: url(themes/website/assets/images/person_2.jpg)"></div>
							<div class="pl-3">
								<p class="name">Roger Scott</p>
								<span class="position">Marketing Manager</span>
							</div>
				...
				<div class="item">
					...
					<div class="text">
						<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						<div class="d-flex align-items-center">
							<div class="user-img" style="background-image: url(themes/website/assets/images/person_3.jpg)"></div>
							<div class="pl-3">
								<p class="name">Roger Scott</p>
								<span class="position">Marketing Manager</span>
							</div>
					...
					<div class="carousel-candidates owl-carousel">
						<div class="item">
							<a href="#" class="team text-center">
								<div class="img" style="background-image: url(themes/website/assets/images/person_1.jpg);"></div>
								<h2>Danica Lewis</h2>
						...
						<div class="item">
							<a href="#" class="team text-center">
								<div class="img" style="background-image: url(themes/website/assets/images/person_2.jpg);"></div>
								<h2>Nicole Simon</h2>
								<span class="position">Western City, UK</span>
							</a>
						</div>
						<div class="item">
							<a href="#" class="team text-center">
								<div class="img" style="background-image: url(themes/website/assets/images/person_3.jpg);"></div>
								<h2>Cloe Meyer</h2>
								<span class="position">Western City, UK</span>
							</a>
						</div>
						<div class="item">
							<a href="#" class="team text-center">
								<div class="img" style="background-image: url(themes/website/assets/images/person_4.jpg);"></div>
						...
						<div class="item">
							<a href="#" class="team text-center">
								<div class="img" style="background-image: url(themes/website/assets/images/person_5.jpg);"></div>
								<h2>Dave Buff</h2>
								<span class="position">Western City, UK</span>
							</a>
						</div>
						<div class="item">
							<a href="#" class="team text-center">
								<div class="img" style="background-image: url(themes/website/assets/images/person_6.jpg);"></div>
								<h2>Dave Buff</h2>
								<span class="position">Western City, UK</span>
							</a>
						</div>
		...
		<div class="container">
			...
			<div class="col-md-12 text-center">
				...
				<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a></p>
			</div>
			</div>
		</div>
		</footer>
	...
	<script src="{{ asset('themes/website/assets/js/jquery.min.js') }}"></script>
