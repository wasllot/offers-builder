...
<script type="text/x-template" id="searchbar-template">
    ...
    <form class="search-job" method="GET" role="search" id="search-form" action="{{ route('velocity.search.index') }}">
            ...
            <div class="col-md mr-md-2">
                <div class="form-group">
                    ...
                    <select id="" class="form-control" name="category" @change="focusInput($event)">
                        <option value="">{{ __('velocity::app.header.all-categories') }}</option>
