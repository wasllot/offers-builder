                            ...
                            @foreach ($order->shipments as $shipment)
                                ...
                                <div class="sale-section">
                                    ...
                                    <br>
                                                ...
                                                @include('shop::customers.account.orders.steps.pending')
                                
                                                @elseif($shipment->status=="dispatched")
                                                @include('shop::customers.account.orders.steps.dispatched')
                                
                                
                                                @elseif($shipment->status=="processed")
                                                @include('shop::customers.account.orders.steps.processed')
                                                
                                
                                                @elseif($shipment->status=="shipped")
                                                @include('shop::customers.account.orders.steps.shipped')
                                                
                                                @elseif($shipment->status=="delivered")
                                                @include('shop::customers.account.orders.steps.delivered')
