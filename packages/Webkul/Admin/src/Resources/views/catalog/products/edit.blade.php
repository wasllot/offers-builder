        ...
        <form method="POST" action="" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-header">
                ...
                <div class="page-action">
                    ...
                    <a href="#" id="download-html-btn" class="btn btn-lg btn-info">
                       Descargar
                    </a>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#download-html-btn').on('click', function(e){
                e.preventDefault();
                $('#channel-switcher').val()
                var query = '?channel=' + $('#channel-switcher').val() + '&locale=' + $('#locale-switcher').val();

                $.ajax({
                    url: "/{{ $product->url_key  }}" + query,
                    type: 'GET',
                    success: function(result) {
                        filename = /[^\/]+$/.exec($('#sku').val())+".html";
                        console.log(filename);
                        uriContent = "data:application/octet-stream,"  + encodeURIComponent(result);
