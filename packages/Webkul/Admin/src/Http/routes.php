    ...
    Route::prefix(config('app.admin_url'))->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('sales')->group(function () {
                ...
                Route::post('/shipments/update_status/', 'Webkul\Admin\Http\Controllers\Sales\ShipmentController@status')->defaults('_config', [
                    'view' => 'admin::sales.shipments.view',
                ])->name('admin.sales.shipments.status');
            ...
            Route::prefix('catalog')->group(function () {
                ...
                Route::get('/products/download/{id}', 'Webkul\Product\Http\Controllers\ProductController@downloadTemplate')->defaults('_config', [
                    'redirect' => 'shop.productOrCategory.index',
                ])->name('admin.catalog.products.download');

                Route::get('/products/edit/builder/{id}', 'Webkul\Product\Http\Controllers\ProductController@editBuilder')->defaults('_config', [
                    'view' => 'admin::catalog.products.editBuilder'
                ])->name('admin.catalog.products.constructor');
                ...
                Route::put('/products/edit/builder/{id}', 'Webkul\Product\Http\Controllers\ProductController@update')->defaults('_config', [
                    'redirect' => 'admin.catalog.products.index'
                ])->name('admin.catalog.products.updateBuilder');
            ...
            Route::prefix('cms')->group(function () {
                ...
                Route::get('edit/constructor/{id}', 'Webkul\CMS\Http\Controllers\Admin\PageController@editBuilder')->defaults('_config', [
                    'view' => 'admin::cms.editBuilder',
                ])->name('admin.cms.constructor');

                Route::post('edit/{id}', 'Webkul\CMS\Http\Controllers\Admin\PageController@update')->defaults('_config', [
                    'redirect' => 'admin.cms.index',
                ])->name('admin.cms.update');

                Route::post('edit/constructor/{id}', 'Webkul\CMS\Http\Controllers\Admin\PageController@update')->defaults('_config', [
                    'redirect' => 'admin.cms.index',
                ])->name('admin.cms.update');
