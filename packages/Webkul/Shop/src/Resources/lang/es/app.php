...
return [
    ...
    'menu-navbar'   => [
        'text-more'     => 'Más',
        'text-category' => 'Buscar por categoría',
    ],
    ...
    'checkout' => [
        'cart' => [
            ...
            'item' => [
                ...
                'inactive' => 'Un artículo está inactivo y ha sido removido del carrito',
                'inactive-add' => 'No se puede agregar un artículo inactivo al carrito',
            ],
            ...
            'event' => [
                'expired' => 'Rste evento ha expirado.'
            ]
        ],
