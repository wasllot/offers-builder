                                    ...
                                    <div class="section-content">
                                        ...
                                        <div class="row top25 inboxMain" >
                                            ...
                                            <div class="row text-center alert alert-info">
                                                ...
                                                <div class="col-md-4"><h3> Status: <mark>{{$shipment->status}}</h3></mark></div>
                                            </div>
                                
                                                @if($shipment->status=="pending")
                                                @include('shop::customer.account.orders.steps.pending')
                                
                                                @elseif($shipment->status=="dispatched")
                                                @include('shop::customer.account.orders.steps.dispatched')
                                
                                
                                                @elseif($shipment->status=="processed")
                                                @include('shop::customer.account.orders.steps.processed')
                                                
                                
                                                @elseif($shipment->status=="shipped")
                                                @include('shop::customer.account.orders.steps.shipped')
                                                
                                                @elseif($shipment->status=="delivered")
                                                @include('shop::customer.account.orders.steps.delivered')
