    ...
    Route::prefix('customer')->group(function () {
        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::prefix('account')->group(function () {
                ...
                //Customer orders view tracking
                Route::get('orders/tracking/{id}', 'Webkul\Shop\Http\Controllers\OrderController@tracking')->defaults('_config', [
                    'view' => 'shop::customers.account.orders.tracking'
